        ...
        <div className="min-h-screen flex items-center justify-center pt-20 px-6">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Join BrainMap and start mastering new topics</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-slate-500 dark:text-slate-400 mb-2 text-sm font-medium">Username</label>
